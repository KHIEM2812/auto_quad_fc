...
#define MEDIUM_FREQUENCY_TASK_RATE2		(uint16_t)SPEED_LOOP_FREQUENCY_HZ
...
#endif
/************************* OBSERVER PARAMETERS ********************************/
#define MAX_BEMF_VOLTAGE2  (uint16_t)((MOTOR_MAX_SPEED_RPM2*\
                           MOTOR_VOLTAGE_CONSTANT2*SQRT_2)/(1000u*SQRT_3))

#define MOTOR_MAX_SPEED_HZ2 (int16_t)((MOTOR_MAX_SPEED_RPM2*10u)/60u)
...
#define MOTOR_MAX_SPEED_DPP2 (int32_t)((1.2*MOTOR_MAX_SPEED_RPM2*65536u*POLE_PAIR_NUM2)\
                                                            /(TF_REGULATION_RATE2*60u))
...
#define DELTA_TEMP_HYSTERESIS2        (OV_TEMPERATURE_HYSTERESIS_C2- T0_C2)
#define DELTA_V_HYSTERESIS2           (dV_dT2 * DELTA_TEMP_HYSTERESIS2)
#define OV_TEMPERATURE_HYSTERESIS_d2  ((V0_V2 + DELTA_V_HYSTERESIS2)*INT_SUPPLY_VOLTAGE2)
...
#if (LOW_SIDE_SIGNALS_ENABLING2 == ENABLE)
#define DEADTIME_NS2  (uint16_t)SW_DEADTIME_NS2
#else
#define DEADTIME_NS2  HW_DEAD_TIME_NS2
#endif

#define DEAD_TIME_COUNTS2  (uint16_t)(ADV_TIM_CLK_MHz2 * DEADTIME_NS2/1000uL)
