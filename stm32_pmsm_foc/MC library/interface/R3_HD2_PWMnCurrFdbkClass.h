...
/** 
  * @brief  R3_HD2 class parameters definition
  */
...
/* Emergency input signal initialization -------------------------------------*/  
  ...
  uint16_t hBKINPin;                    /*!< Emergency Stop (BKIN) GPIO input pin 
                                           (if used, after re-mapping). It must be 
                                           GPIO_Pin_x x= 0, 1, ...*/     
}R3_HD2Params_t, *pR3_HD2Params_t;
/**
  * @}
  */
