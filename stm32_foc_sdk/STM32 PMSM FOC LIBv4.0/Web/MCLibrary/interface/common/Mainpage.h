 ...
 *			- STM32 PMSM Motor control software library v4.0 classes interfaces (module STM32_PMSM_MC_Library).\n
 *			Classes related parameters data structures (XXXParams_t) and class related methods descriptions are here reported 
 *			for each of the classes included in STM32 PMSM motor control software library v4.0
